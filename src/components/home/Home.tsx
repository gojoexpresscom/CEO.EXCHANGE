    ...
    <div style={styles.page}>
      ...
      <main style={styles.content}>
        ...
        <section style={styles.marketSection}>
          ...
          {filteredMarkets.map((m) => <MarketRow key={m.symbol} market={m} favorite={JSON.parse(localStorage.getItem("ceo-market-favorites") || "[]").includes(m.symbol)} onFavorite={() => toggleFavorite(m.symbol)} onTrade={() => onTrade(m.symbol)} />)}
